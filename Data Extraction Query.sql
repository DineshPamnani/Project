...
-- Average Equity Taken (Where deals were made)
...
-- Pitches with atlease 1 Female contestant
...
-- Pitches converted having one female contestant
...
-- Amount invested per deal (only where funding received)
...
-- Anupam and Ashneer statistics combined
...
-- Sector-wise startup with highest investment
SELECT a.* FROM 
